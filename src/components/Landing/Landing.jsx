        ...
        >
          <div className="lcl--content">
            {socialsData.linkedIn && (
              <a
                href="https://www.linkedin.com/in/suman-sahu5/"
                target="_blank"
                rel="noreferrer"
              >
                <FaLinkedin
            ...
            {socialsData.github && (
              <a
                href="https://github.com/suman527"
                target="_blank"
                rel="noreferrer"
              >
                <FaGithub
            ...
            >
              <div style={{ marginBottom: "30px" }}>
                {headerData.resumePdf && (
                  <a
                    href="https://drive.google.com/file/d/1wAwMpCX1EdJFdefDkphjFI04xiNFu8yV/view?usp=drivesdk"
                    download="resume"
                    target="_blank"
                    rel="noreferrer"
                  >
